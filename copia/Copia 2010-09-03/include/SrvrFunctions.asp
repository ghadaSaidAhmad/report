...
Function getReportRows()
    ...
    dim NFilasACTIVITY: NFilasACTIVITY = 5
    ...
    dim NFilasExtra: NFilasExtra = nFilas_RealDataNShops + nFilas_RealDataPercentComplaint + nFilas_KPIQuality + nFilas_Quality + nFilas_NRVSLY + nFilas_FC + nFilas_NR + nFilas_GeneralTheme     ' Número de filas de General Theme, NR, LY, etc...
