	...
	<table border=0 cellpadding=0 cellspacing=0 width="600px" style="border:1 solid gray;" align=center><tr height="400px"><td align="center" valign="top" style="border-right:2px solid black;border-bottom:2px solid black;">
	    ...
	    <tr>
		    <td align="left" style="padding-left:5">
			    <img src="images/options.png" /><FONT class="font20">&nbsp;&nbsp;&nbsp;<STRONG><%=IDM_ConfigParametersTitle%></STRONG></FONT>
		    </td>
		    <td align=right>
		        <img onclick="Save();" title="<%=IDM_MenuSaveParameters %>" style="cursor:pointer;border:2 solid white;" onmouseover="this.style.border = '2 solid gray';" onmouseout="this.style.border = '2 solid white';" src="images/save.png" />
		    </td>
		</tr>
		</table>
		...
		while not rst.EOF
			...
			<%else%>
				<TR>
					<TD width=20></TD>
					<TD width=350 valign=top style="border-bottom:1 solid gray;"><font class=font12><%=rst("Description")%></TD>
					<TD valign=top>
						<%
						dim strInputWidth
						dim ArrValues, a
