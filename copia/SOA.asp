...
<%end if %>
    ...
    '################################
        ...
        if Request.Form("FILTER_SHOWREALDATA_NSHOPS")<>"" then nFilas_RealDataNShops = 1
        
        dim nFilas_RealDataPercentComplaint: nFilas_RealDataPercentComplaint = 0
        if Request.Form("FILTER_SHOWREALDATA_PERCENTCOMPLAINT")<>"" then nFilas_RealDataPercentComplaint = 1
        ...
        dim NFilasExtra: NFilasExtra = 1 + nFilas_RealDataNShops + nFilas_RealDataPercentComplaint + nFilas_NRVSLY + nFilas_FC + nFilas_NR + nFilas_GeneralTheme     ' Número de filas de General Theme, NR, LY, etc...
    '################################
    ReportNumRowsPerYear = getReportRows(Idioma) + NFilasExtra
