    ...
    <table style="width:100%;height:30px;">
        <tr>
            ...
            <%if FALSE then %>
                ...
                <td>
                    <input name="PercentComplaint" value="<%=act.PercentComplaint %>" class="textfield" type="text" onKeyPress="return ControlOnlyNumbers(event)" onchange="changeMade();" style="width:100%;" />
                </td>
            <%end if %>
        </tr>
