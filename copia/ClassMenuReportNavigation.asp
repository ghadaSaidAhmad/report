        ...
        <tr>
            ...
            for each c in arrClients
                ...
                if isInArray(Request.Form("FILTER_MULTICLIENT"), c.IDClient) then
                    ...
                    %>&nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="" onclick="thisForm.FILTER_REPORTTYPE.value='0';thisForm.FILTER_BRAND.value='';thisForm.FILTER_CLIENT.value='<%=c.IDClient %>';thisForm.submit();return false;">
        ...
        <tr>
            ...
            for each b in arrBrands
                ...
                if isInArray(Request.Form("FILTER_MULTIBRAND"), b.IDBrand) then
                    ...
                    %>&nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="" onclick="thisForm.FILTER_REPORTTYPE.value='1';thisForm.FILTER_CLIENT.value='';thisForm.FILTER_BRAND.value='<%=b.IDBrand %>';thisForm.submit();return false;">
                        <font style="cursor:pointer;">
