...
function editElement(val , tipo){
	if (tipo=="Client"){
		...
		window.open('BrandNewEdit.asp?IDBrand=' + val,'Brand','top=200,left=300,width=350,height=200,scrollbars');
	}
	    ...
	    <tr>
		    ...
		    <td align=right>
		        ...
		        <%elseif Pestana="2" then	'estamos en la pestaña de Grupos%>
			        <a href="" title="<%=IDM_NewBrand%>" onclick="window.open('BrandNewEdit.asp?NewBrand=1','Brand','top=200,left=300,width=350,height=200,scrollbars');return false;"><img src="images/add.png" border=0></a>
		        </td></tr>
		        <%end if%>
