<script runat=server language="vbscript">
    ...
    public function getClients()
        ...
        set rst = Server.CreateObject("ADODB.RecordSet")
        SQL = "SELECT IDClient FROM Client WHERE indBaja=0 ORDER BY Name"
    ...
    public sub saveClient(cli)
        ...
        if cli.IDClient > -1 then
            ...
            isNew = true
            ' New Activity
            SQL = "INSERT INTO Client (Name, ShortName, indBaja, SiebelCode, ImageFileNameH, ImageFileNameV " & _
            " ) " & _
            " VALUES ('" & Replace(cli.Name, "'", "''") & "', '" & Replace(cli.ShortName, "'", "''") & "', '" & Replace(cli.indBaja, "'", "''") & "', '" & Replace(cli.SiebelCode, "'", "''") & "', '" & Replace(cli.ImageFileNameH, "'", "''") & "', '" & Replace(cli.ImageFileNameV, "'", "''") & "' " & _
            " )"
