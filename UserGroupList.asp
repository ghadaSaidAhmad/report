...
<table border=0 cellpadding=0 cellspacing=0 width="600px" style="border:1px solid gray;" align=center ><tr height=400px><td align=center valign=top style="border-right:2px solid black;border-bottom:2px solid black;">
    ...
    <table class="TB_TITLE" cellpadding=0 cellspacing=0 width="100%" style="align:left;"><tr><td>
	    ...
	    <tr>
		    ...
		    <td align=right>
			    ...
			    <%if Pestana="1" then	'estamos en la pestaña de Usuarios%>
				    <input style="height:30px;cursor:pointer;border:2px solid white;" onmouseover="this.style.border = '2px solid gray';" onmouseout="this.style.border = '2px solid white';" alt="<%=IDM_NewUser%>" type="image" src="images/add.png" value="New User" onclick="window.open('UserNewEdit.asp?NewUser=1','User','top=200,left=300,width=400,height=400,scrollbars');return false;">
				    <Input style="cursor:pointer;border:2px solid white;" onmouseover="this.style.border = '2px solid gray';" onmouseout="this.style.border = '2px solid white';" alt="<%=IDM_Search%>" type=image src="images/search.png" value="<%=IDM_Search%>" onclick="_fireEvent('Search','click','');return false;">
    			
			    <%elseif Pestana="2" then	'estamos en la pestaña de Grupos%>
				    <input style="height:30px;cursor:pointer;border:2px solid white;" onmouseover="this.style.border = '2px solid gray';" onmouseout="this.style.border = '2px solid white';" alt="<%=IDM_NewGroup%>" type="image" src="images/add.png" value="New Group" onclick="window.open('GroupNewEdit.asp?NewGroup=1','Group','top=200,left=300,width=400,height=300,scrollbars');return false;">
				    <Input style="cursor:pointer;border:2px solid white;" onmouseover="this.style.border = '2px solid gray';" onmouseout="this.style.border = '2px solid white';" alt="<%=IDM_Search%>" type=image src="images/search.png" value="<%=IDM_Search%>" onclick="_fireEvent('Search','click','');return false;">
			    <%end if%>
	    ...
	    <table border=0 cellpadding=0 cellspacing=0 width="100%" style="align:left;">
	            <tr>
