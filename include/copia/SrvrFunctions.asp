...
Function getReportRows()
    ...
    dim NFilasExtra: NFilasExtra = nFilas_RealDataNShops + nFilas_RealDataPercentComplaint + nFilas_Quality + nFilas_NRVSLY + nFilas_FC + nFilas_NR + nFilas_GeneralTheme     ' Número de filas de General Theme, NR, LY, etc...
